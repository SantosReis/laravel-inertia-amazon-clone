        ...
        <div class="flex gap-4">
            <div class="w-full bg-white p-4 mt-4">
                <div class="border-b">
                    ...
                    <div
                        class="text-sm w-full flex justify-end items-center font-semibold"
                    >
                        Price
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="flex justify-between mb-4">
                        <div class="pl-8 py-10 relative">
                            <div
                                class="text-gray-900 pb-2 -mt-4 font-bold text-[18px]"
                            >
                                {{ product.title }}
                            </div>
                            <span
            ...
            <div class="bg-white w-[350px] p-4 mt-4 h-48">
                <div class="text-sm text-green-700">
                    Welcome to Amazon! FREE Delivery on your first order to UK
                    or Ireland. Select this option at checkout.
                </div>
