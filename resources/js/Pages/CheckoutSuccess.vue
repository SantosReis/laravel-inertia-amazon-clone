        ...
        <div class="max-w-xl mx-auto">
            <div class="flex flex-col p-5 rounded-lg shadow bg-white">
                <div class="flex flex-col items-center text-center">
                    ...
                    <p
                        class="mt-2 text-lg font-bold text-gray-600 leading-relaxed"
                    >
                ...
                <Link :href="route('dashboard')" class="flex items-center mt-3">
                    <button
                        class="flex-1 px-4 py-2 ml-2 bg-yellow-500 hover:bg-yellow-500 text-gray-900 font-bold rounded-md"
                    >
                        Home
                    </button>
                </Link>
